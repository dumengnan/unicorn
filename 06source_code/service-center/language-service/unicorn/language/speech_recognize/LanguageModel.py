...
class ModelLanguage():  # 语音模型类
    def __init__(self, modelpath):
        ...
        self.dict_pinyin = self.GetSymbolDict(self.modelpath + 'dict.txt')
            ...
            if (i == 0):
                ...
                for j in range(0, num_ls_word):
                    ...
                    for k in range(0, num_ls):
                        ...
                        tuple_word[0] = tuple_word[0] + ls[
                            k]  # 尝试按照下一个音可能对应的全部的字进行组合
                        # print('ls[k]  ',ls[k])
                        ...
                        if (tmp_words in self.model2):  # 判断它们是不是再状态转移表里
                            ...
                            tuple_word[1] = tuple_word[1] * float(
                                self.model2[tmp_words]) / float(
...
if (__name__ == '__main__'):
    ...
    str_pinyin = ['ba3', 'zhe4', 'xie1', 'zuo4', 'wan2', 'wo3', 'jiu4', 'qu4',
                  'shui4', 'jiao4']
