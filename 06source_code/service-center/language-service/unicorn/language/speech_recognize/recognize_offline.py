...
detect_speech_api = Blueprint('detect_language_api', __name__, template_folder='templates')


@detect_speech_api.route('/language/recognize/chinese/offline', methods=['POST'])
